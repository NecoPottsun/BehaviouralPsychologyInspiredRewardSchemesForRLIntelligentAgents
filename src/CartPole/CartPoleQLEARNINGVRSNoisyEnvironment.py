...
class CartPoleQLEARNINGVRSNoisyEnvironment:
    ...
    def train(self, episodes, render):
        ...
        path = 'cart_pole_Q-learning_VRS_' + \
        ...
        plt.suptitle('Cart pole Q-learning applying VRS %s, Noisy = %s, Time = %f' % (self.reward_schedule, self.environment_name,
                     end_time_running_all_episodes))
        png_file = auxFunctions.create_filename(
            'cart_pole', 'Q-learning', 'png', other=other)
